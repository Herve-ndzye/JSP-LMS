...
<head>
    ...
    <title>Library Management System - Students</title>
...
<body>
    <div class="header">
        <div class="header-content">
            ...
            <p>Manage student accounts and book borrowing operations</p>
        </div>
    </div>
    ...
    <div class="container">
            ...
            <form action="students" method="post">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="id" name="id" required placeholder="Enter student ID">
                    </div>
                    <div class="form-group">
        ...
        <div class="content">
            <div class="section">
                <h3 class="section-header">Registered Students</h3>
                <% 
                ...
                %>
                    <div class="empty-state">
                        ...
                        <p>Register your first student to get started with the library system.</p>
                    </div>
                <% } %>
            </div>

            <div class="section">
                <h3 class="section-header">Book Operations</h3>
                <% 
                ...
                %>
                    <div class="empty-state">
                        ...
                        <p>Add books to the library to enable borrowing operations.</p>
                    </div>
                <% } %>
            </div>
        </div>
